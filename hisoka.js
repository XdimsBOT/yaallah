...
//────────────────────[ MAIN MENU HOOOOOOHHH ]────────────────────
            ...
            case 'menu': case 'help': case '?': {
                buffer = await getBuffer(`https://i.ibb.co/5LftJRm/elaina-anime.jpg)
                anu = `Hai kak ${pushname}, have a nice day:)

Saya adalah ${botname}, 
Saya adalah ${botname}, program untuk
memudahkan anda untuk membuat sticker
dll the spirit of the day, the point is to keep smiling 
